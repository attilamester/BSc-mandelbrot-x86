...
nasm -f elf32 "$ASM_DIR/mandelbrot.asm" -I"$INC_DIR" -o "$BUILD_DIR/mandelbrot.o"

nasm -f elf32 "$SHIM_DIR/io_shim.asm" -o "$BUILD_DIR/io_shim.o"
gcc $CFLAGS -c "$C_DIR/io.c" -o "$BUILD_DIR/io.o"
ar rcs "$BUILD_DIR/libio.a" "$BUILD_DIR/io_shim.o" "$BUILD_DIR/io.o"

nasm -f elf32 "$SHIM_DIR/gfx_shim.asm" -o "$BUILD_DIR/gfx_shim.o"
...
nasm -f elf32 "$SHIM_DIR/util_shim.asm" -o "$BUILD_DIR/util_shim.o"
